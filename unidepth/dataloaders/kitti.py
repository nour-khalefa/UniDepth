...
class KITTIDataset(BaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        image, intrinsics, depth = self.resize_and_pad(image, intrinsics,depth)
    ...
    def resize_and_pad(self, image, intrinsics,depth):
        ...
        return padded_image, intrinsics, padded_depth
